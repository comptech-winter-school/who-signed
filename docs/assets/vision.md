# *«Кто подписал?» CompTech Winter School 2022*
...
- Человека, которому принадлежит подпись с точностью:

| Precision   | Recall  | F1-score |
|:---         | ---     |      ---:|
|  0.9        | 0.9     | 0.9      |

- Является ли подпись подделкой с точностью:
...
Системные требования для  приложения Telegram: Система Android, iOS, Windows Phone, Windows, macOS или GNU/Linux.
